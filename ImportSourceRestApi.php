...
class ImportSourceRestApi extends ImportSourceHook
{
    ...
    {
        $request_type = $this->getSetting('method');
        ...
        if ($request_type == 'get')
        {
            ...
            $result = $this->getRestApi()->post($this->getUrl(), $body);
        }
    ...
    public static function addSettingsFormFields(QuickForm $form)
    {
        ...
        static::addRequestType($form);
        static::addPostBody($form);
    }
     ...
     * @throws \Zend_Form_Exception
     */
    protected static function addRequestType(QuickForm $form)
    {
        $form->addElement('select', 'method', [
            'label' => $form->translate('request_type'),
            'description' => $form->translate(
                'Whether to use get or post as request method'
            ),
            'multiOptions' => [
                'post' => $form->translate('Post as request method'),
                'get'  => $form->translate('Get as request method'),
            ],
            'class'    => 'autosubmit',
            'value'    => 'get',
            'required' => true,
   ...
   /**
     ...
     * @throws \Zend_Form_Exception
     */
    protected static function addPostBody(QuickForm $form)
    {
        $form->addElement('text', 'body', array(
            'label'    => 'Post Body',
            'description' => $form->translate(
